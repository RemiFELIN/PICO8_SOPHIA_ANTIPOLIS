...
function _init()
  ...
  interaction = false
  start_bulle = false
  checkpointx = 980 --pour memoriser le dernier checkpoint
  checkpointy = 460
...
function projectils_update()
  for projectil in all(projectils) do
    ...
    for droid in all(droids) do
      ...
      if projectil.x<player.x-120 
      or projectil.x>player.x+120 
      or collide_map(projectil,"right",0)
...

...
__gff__

